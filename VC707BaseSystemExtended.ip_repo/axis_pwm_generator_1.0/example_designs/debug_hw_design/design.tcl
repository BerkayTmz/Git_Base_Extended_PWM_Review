...
proc create_ipi_design { offsetfile design_name } {
	...
	# Connect all clock & reset of axis_pwm_generator_0 slave interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins axis_pwm_generator_0/S_AXI_LITE]
	connect_bd_net [get_bd_pins axis_pwm_generator_0/s_axi_lite_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins axis_pwm_generator_0/s_axi_lite_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]

	# Connect all clock & reset of axis_pwm_generator_0 streaming interfaces..
	connect_bd_net [get_bd_pins axis_pwm_generator_0/s_axis_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins axis_pwm_generator_0/s_axis_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]


	# Auto assign address
	assign_bd_address

	# Copy all address to axis_pwm_generator_v1_0_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/axis_pwm_generator_v1_0_include.tcl"
	set fp [open $offset_file "w"]
	puts $fp "# Configuration address parameters"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_axis_pwm_generator_0_S_AXI_LITE_* ]]
...
set hw_test_file ${ip_path}/example_designs/debug_hw_design/axis_pwm_generator_v1_0_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "axis_pwm_generator_v1_0_hw_${i}"
