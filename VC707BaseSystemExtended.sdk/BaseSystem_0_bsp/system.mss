...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = axi_bus_driver
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = axi_bus_driver_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axidma
 PARAMETER DRIVER_VER = 9.3
 PARAMETER HW_INSTANCE = axi_pwm_dma_0
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = axis_pwm_generator
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = axis_pwm_generator_0
END
